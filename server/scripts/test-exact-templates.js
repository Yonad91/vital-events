...
// Sample data that matches the exact template structure
const sampleEvents = {
  birth: {
    _id: 'test-birth-exact-123',
    type: 'birth',
...
async function testExactTemplateGeneration() {
  console.log('🧪 Starting Exact Template Certificate Generation Test...\n');
  ...
  for (const [certType, event] of Object.entries(sampleEvents)) {
    console.log(`\n📋 Testing ${certType.toUpperCase()} Certificate with Exact Template Matching:`);
    ...
    try {
      ...
      console.log(`✅ Exact template certificate generated successfully!`);
      ...
      if (certType === 'birth') {
        ...
        console.log(`- Birth Place: ${result.certificateData.childBirthPlace}`);
        console.log(`- Nationality: ${result.certificateData.childNationality}`);
        ...
        console.log(`- Marriage Place: ${result.certificateData.marriagePlace}`);
        console.log(`- Marriage Type: ${result.certificateData.marriageType}`);
        ...
        console.log(`- Death Place: ${result.certificateData.deathPlace}`);
        console.log(`- Age: ${result.certificateData.deceasedAge}`);
        ...
        console.log(`- Divorce Type: ${result.certificateData.divorceType}`);
        console.log(`- Reason: ${result.certificateData.divorceReason}`);
      }
  ...
  console.log('\n🎉 Exact Template Certificate Generation Test Completed!');
  console.log('\n📁 Check the server/certificates/ directory for generated files.');
  console.log('📄 Generated certificates now include:');
  ...
  console.log('   - Correct field positioning and layout');
  console.log('   - Professional appearance matching official documents');
}

// Run the test
testExactTemplateGeneration().catch(console.error);
